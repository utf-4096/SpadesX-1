...
void command_populate_all(server_t* server)
{
    ...
    {"/admin",      0, &cmd_admin,            PERM_ANY,         "Sends a message to all online admins."                        },
    {"/adminmute",  1, &cmd_admin_mute,       PERM_MIN_GUARD,   "Mutes or unmutes player from /admin usage"                    },
    {"/ban",        0, &cmd_ban_custom,       PERM_MIN_GUARD,   "Puts specified IP into ban list"                              },
    {"/banrange",   0, &cmd_ban_range,        PERM_MIN_GUARD,   "Bans specified IP range"                                      },

 // We can have 2+ commands for same function even with different permissions and name
    {"/client",     1, &cmd_clin,             PERM_ANY,         "Shows players client info"                                    },
    {"/clin",       1, &cmd_clin,             PERM_ANY,         "Shows players client info"                                    },
    {"/dban",       0, &cmd_ban_custom,       PERM_MIN_GUARD,   "Bans specified player for a day"                              },
    {"/hban",       0, &cmd_ban_custom,       PERM_MIN_GUARD,   "Bans specified player for 6 hours"                            },
    {"/help",       0, &cmd_help,             PERM_ANY,         "Shows commands and their description"                         },
    {"/intel",      0, &cmd_intel,            PERM_ANY,         "Shows info about intel"                                       },
    {"/inv",        0, &cmd_inv,              PERM_MIN_GUARD,   "Makes you go invisible"                                       },
    {"/kick",       1, &cmd_kick,             PERM_MIN_GUARD,   "Kicks specified player from the server"                       },
    {"/kill",       1, &cmd_kill,             PERM_ANY,         "Kills player who sent it or player specified in argument"     },
    {"/login",      1, &cmd_login,            PERM_ANY,         "Login command. First argument is a role. Second password"     },
    {"/logout",     0, &cmd_logout,           PERM_MIN_TRUSTED, "Logs out logged in player"                                    },
    {"/master",     0, &cmd_master,           PERM_MIN_ADMIN,   "Toggles master connection"                                    },
    {"/mban",       0, &cmd_ban_custom,       PERM_MIN_GUARD,   "Bans specified player for a month"                            },
    {"/mute",       1, &cmd_mute,             PERM_MIN_GUARD,   "Mutes or unmutes specified player"                            },
    {"/pban",       0, &cmd_ban_custom,       PERM_MIN_GUARD,   "Permanently bans a specified player"                          },
    {"/pm",         0, &cmd_pm,               PERM_ANY,         "Private message to specified player"                          },
    {"/ratio",      1, &cmd_ratio,            PERM_ANY,         "Shows yours or requested player ratio"                        },
    {"/reset",      0, &cmd_reset,            PERM_MIN_ADMIN,   "Resets server and loads next map"                             },
    {"/say",        0, &cmd_say,              PERM_MIN_GUARD,   "Send message to everyone as the server"                       },
    {"/server",     0, &cmd_server,           PERM_ANY,         "Shows info about the server"                                  },
    {"/tb",         1, &cmd_toggle_build,     PERM_MIN_GUARD,   "Toggles ability to build for everyone or specified player"    },
    {"/tk",         1, &cmd_toggle_kill,      PERM_MIN_GUARD,   "Toggles ability to kill for everyone or specified player"     },
    {"/tp",         1, &cmd_tp,               PERM_MIN_ADMIN,   "Teleports specified player to another specified player"       },
    {"/tpc",        1, &cmd_tpc,              PERM_MIN_ADMIN,   "Teleports to specified cordinates"                            },
    {"/ttk",        1, &cmd_toggle_team_kill, PERM_MIN_GUARD,   "Toggles ability to team kill for everyone or specified player"},
    {"/unban",      0, &cmd_unban,            PERM_MIN_GUARD,   "Unbans specified IP"                                          },
    {"/unbanrange", 0, &cmd_unban_range,      PERM_MIN_GUARD,   "Unbans specified IP range"                                    },
    {"/undoban",    0, &cmd_undo_ban,         PERM_MIN_GUARD,   "Reverts the last ban"                                         },
    {"/ups",        1, &cmd_ups,              PERM_ANY,         "Sets UPS of player to requested ammount. Range: 1-300"        },
    {"/wban",       0, &cmd_ban_custom,       PERM_MIN_GUARD,   "Bans specified player for a week"                             },
    {"/shutdown",   0, &cmd_shutdown,         ROLE_MANAGER,     "Shutdown the server"                                          }
    };
